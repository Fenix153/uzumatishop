...
BOT_TOKEN = os.getenv("BOT_TOKEN", "")          # Токен бота из Discord Developer Portal
GUILD_ID   = int(os.getenv("GUILD_ID", "0"))             # ID твоего Discord сервера
ADMIN_ID   = int(os.getenv("ADMIN_ID", "0"))             # Твой Discord User ID
LOG_CHANNEL_ID = int(os.getenv("LOG_CHANNEL_ID", "0"))         # ID канала для уведомлений
